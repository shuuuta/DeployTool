<?php
    ...
    */
    $options = array(
        'directory'     => '',
        'work_dir'      => '',// leave it blank or null if you are using .git directory
        'log'           => 'deploy_log.log',
        'branch'        => 'master',
        'remote'        => 'origin',
        ...
        */
        public function execute()
        {
            try {
                ...
                exec($this->_git_bin_path . ' --git-dir=' . $this->_directory . '.git fetch', $output);
                $this->log('Fetching changes... '.implode(' ', $output));

                // Checking out to web directory
                exec($this->_git_bin_path . ' --git-dir=' . $this->_directory . '.git --work-tree=' . $this->_work_dir . ' checkout -f', $output);
